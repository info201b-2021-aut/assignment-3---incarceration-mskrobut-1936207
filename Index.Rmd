...
```{r, echo=FALSE, message=FALSE}
source("C2-ScatterComparison.R")
```

### Chart 3: Map
This chart is a map that shows 6 states: Washington, Oregon, California, Alabama, Georgia, and Floria. It shows the percent of black people of a county's total incarcerated population in 2018 in every county in every state. I wanted to compare counties and state that were on opposites sides of the United States and see how their percentages compared. The color gradient scale / key allows the viewer to easy see that the percent of black people of the total incarcerated population is far lower on the west coast in comparison to the south.
