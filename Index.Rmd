...
ggplot(Chart1PercentJailPopBlack, aes(x=year, y=PercentofJailPop_Black)) +
  ...
  theme_bw(base_size = 200), echo=FALSE}
...
### Chart 3: Map
This chart is a map of Washington and it compares the percent of black people of the county's total population in jail in 2018. I wanted to see how the percentage differed around the state. I was able to make lots of different maps but for some reason I was have trouble with adding my data into it. I added a picture of one of the maps I made but it the  data won't input it. I have lots of code in the analysis file that should some of the many ways I tried to get the map to work. 
...
library(ggplot2)
  ...
  plot_usmap(regions = "counties", data=county_data2018, values="PercentofJailPop_Black", exclude=NA, color = "red") +
    ...
    theme(legend.position = "right"), echo=FALSE}
